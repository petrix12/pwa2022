...
if (typeof module !== 'undefined' && module.exports) {
  ...
  Pouch.merge = require('./pouch.merge.js.js').merge;
  Pouch.collate = require('./pouch.collate.js.js').collate;
  Pouch.replicate = require('./pouch.replicate.js.js').replicate;
  Pouch.utils = require('./pouch.utils.js.js');
  extend = Pouch.utils.extend;
  module.exports = Pouch;
  var PouchAdapter = require('./pouch.adapter.js.js');
  ...
  require('./plugins/pouchdb.mapreduce.js.js');
  require('./deps/uuid.js.js');
} else {
  window.Pouch = Pouch;
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = Pouch;
  var utils = require('./pouch.utils.js.js');
  for (var k in utils) {
    global[k] = utils[k];
  }
}
